    ...
    <LayoutSidebar>
      <div className="responsive-padding" style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
        <div style={{ marginBottom: '2rem' }}>
          <h1 style={{ fontSize: 'var(--font-h1)', fontWeight: 800, marginBottom: '0.5rem' }}>Appointments</h1>
        ...
        <div className="card" style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          <div style={{ display: 'flex', gap: 'var(--container-gap)', flexWrap: 'wrap' }}>
            <div style={{ flex: 1, minWidth: '280px', background: 'var(--neutral-200)', padding: '1.5rem', borderRadius: '12px' }}>
